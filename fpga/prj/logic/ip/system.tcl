...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {142.857141} \
   ...
   CONFIG.PCW_CLK1_FREQ {142857141} \
   CONFIG.PCW_CLK2_FREQ {166666665} \
