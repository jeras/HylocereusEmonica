...
CONFIG.NUM_WRITE_OUTSTANDING {1} \
  ...
  connect_bd_net -net M_AXI_GP0_ACLK [get_bd_ports M_AXI_GP0_ACLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_sys/M04_ACLK] [get_bd_pins axis_clock_converter_la/s_axis_aclk] [get_bd_pins axis_clock_converter_osc0/s_axis_aclk] [get_bd_pins axis_clock_converter_osc1/s_axis_aclk] [get_bd_pins processing_system7/M_AXI_GP0_ACLK]
  connect_bd_net -net M_AXI_GP0_ARESETn_1 [get_bd_ports M_AXI_GP0_ARESETn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_sys/M04_ARESETN] [get_bd_pins axis_clock_converter_la/s_axis_aresetn] [get_bd_pins axis_clock_converter_osc0/s_axis_aresetn] [get_bd_pins axis_clock_converter_osc1/s_axis_aresetn]
